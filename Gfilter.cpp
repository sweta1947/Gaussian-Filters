				...
				if (c < 3)
				{
					...
					for (int n = j;n < var1.cols; n++, d++)
					{
						if (d < 3)
						{
							...
							{
								var2.at<Vec3b>(i + 1, j + 1)[0] += var1.at<Vec3b>(m, n)[0] *A[m-i][n-j]/16;
								var2.at<Vec3b>(i + 1, j + 1)[1] += var1.at<Vec3b>(m, n)[1] * A[m - i][n - j] / 16;
								var2.at<Vec3b>(i + 1, j + 1)[2] += var1.at<Vec3b>(m, n)[2] * A[m - i][n - j] / 16;
							}
						}
					}
				}
